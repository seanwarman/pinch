...
module.exports = function(grunt) {
  ...
  grunt.config.set('sails-linker', {
    ...
    samplesInjectJs: {
      options: {
        startTag: '// INJECT SAMPLES',
        endTag: '// INJECT SAMPLES END',
        fileTmpl: '\'%s\',',
        appRoot: '.tmp/public'
      },
      files: {
        '.tmp/public/**/*.js': require('../pipeline').samplesToInject,
        'assets/js/**/*.js': require('../pipeline').samplesToInject
      }
    },
    samplesInjectHtml: {
      options: {
        startTag: '<!--SAMPLES-->',
        endTag: '<!--SAMPLES END-->',
        fileTmpl: '<li v-on:click="currentSample = \'%s\'"></li>',
        appRoot: '.tmp/public'
      },
      files: {
        '.tmp/public/**/*.html': require('../pipeline').samplesToInject,
        'views/**/*.html': require('../pipeline').samplesToInject,
        'views/**/*.ejs': require('../pipeline').samplesToInject
      }
    },
    devJs: {
      options: {
